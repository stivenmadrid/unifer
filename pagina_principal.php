...
<!-- Bootstrap core JavaScript-->
    <script src="../bootstrapDB/vendor/jquery/jquery.min.js"></script>
    <script src="../bootstrapDB/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- Core plugin JavaScript-->
    <script src="../bootstrapDB/vendor/jquery-easing/jquery.easing.min.js"></script>

    <!-- Custom scripts for all pages-->
    <script src="../bootstrapDB/js/sb-admin-2.min.js"></script>

    <!-- Page level plugins -->
    <script src="../bootstrapDB/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../bootstrapDB/js/demo/chart-area-demo.js"></script>
    <script src="../bootstrapDB/js/demo/chart-pie-demo.js"></script>
