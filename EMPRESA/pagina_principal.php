...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../EMPRESA/pagina_principal.php">
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
        ...
        <a class="dropdown-item d-flex align-items-center" href="#">
            ...
            <div class="font-weight-bold">
                ...
                <div background=black; class="small text-gray-500">BIENVENIDO A SU PLATAFORMA UNIFER <?PHP echo('nomusu')?></div>
            </div>
        </a>
